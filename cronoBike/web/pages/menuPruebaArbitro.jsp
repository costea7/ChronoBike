 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Información prueba</li> 
      </ol>
      ...
      <div class="row"> 
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h4>Designaciones<sup style="font-size: 20px"></sup></h4> 
            </div>    
            <a href="tables/designaciones.html" class="small-box-footer">Consulta <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="forms/formClasificacion.jsp" class="small-box-footer">Consulta <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
