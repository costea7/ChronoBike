 ...
 * @author Félix
 */
@WebServlet(name = "SendToQueue", urlPatterns = {"/sendToQueue"})
public class SendToQueue extends HttpServlet {
...
//        String rutaFichero = request.getParameter("file");
//        System.out.println("Ruta fichero: " + rutaFichero);
//        String msg = LectorCSV.procesarFichero(rutaFichero);
//        System.out.println("He llegado aquí");
//        
//        this.sendJMSMessageToQueue01(msg);
    ...
    public void sendJMSMessageToQueue01(String _txt)  {
